...
// build the nav
navList.setAttribute('style', 'background-color: #bdbdbd; display: flex; justify-content:start; overflow:auto; ');

const topSection = document.createElement('li');
topSection.className='menu__link';
topSection.textContent = "Back to Top";
navList.appendChild(topSection);

const addSection = document.createElement('li');
addSection.className='menu__link';
addSection.textContent = "Add Section";
navList.appendChild(addSection);

const firstSection = document.createElement('li');
firstSection.className='menu__link';
firstSection.id='sec1';
firstSection.textContent = "Section 1";
navList.appendChild(firstSection);

const secondSection = document.createElement('li');
secondSection.textContent = "Section 2";
secondSection.className='menu__link';
secondSection.id='sec2';
navList.appendChild(secondSection);

const thirdSection = document.createElement('li');
thirdSection.className='menu__link';
thirdSection.id='sec3';
thirdSection.textContent = "Section 3";
navList.appendChild(thirdSection);
...
addSection.addEventListener('click', function addNextSection(){
    ...
    secArray.push(nextSec);
    
    const nextSection = document.createElement('li');
    nextSection.className='menu__link';
    nextSection.textContent = `Section ${num}`;
    nextSection.id = `sec${num}`;
    liArray.push(nextSection);
    navList.appendChild(nextSection);
...
navList.addEventListener('click', function roll(){
    for (let i = 2; i < liArray.length; i++) {
